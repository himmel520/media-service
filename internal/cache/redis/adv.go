...
func (r *AdvCache) Set(ctx context.Context, key string, advs []*models.AdvResponse) error {
...
func (r *AdvCache) Get(ctx context.Context, key string) ([]*models.AdvResponse, error) {
